      ...
      <div className="header">
        ...
        <div className="header__nav">
          ...
          <Link style={{textDecoration: 'none'}} to="/men">
            <span className="header__navItems">Kids Dress</span>
          </Link>
          <Link style={{textDecoration: 'none'}} to="/women">
            <span className="header__navItems">Women's Dress</span>
          </Link>
        </div>
            ...
            <div className="header2__nav">
              ...
              <div className="header2__navItem">
                <Link style={{textDecoration: 'none'}} to="/men" onClick={showNavBar} >
                  <span className="header2__navItems">Kid's Dress</span>
                </Link>
              </div>
              <div className="header2__navItem">
                <Link style={{textDecoration: 'none'}} to="/women" onClick={showNavBar} >
                  <span className="header2__navItems">Women's Dress</span>
                </Link>
              </div>
            </div>
      </div>
